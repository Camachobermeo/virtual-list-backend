...
try {
  ...
  $sentencia = $base_de_datos->prepare("UPDATE empresa SET (obligar_persona, obligar_correo, obligar_celular, logo) = (?, ?, ?, ?) WHERE rut = '$params->empresa'");
  $resultado = $sentencia->execute([$persona, $correo, $celular, $params->logo]);
