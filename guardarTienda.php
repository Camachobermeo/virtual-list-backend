...
try {
  ...
  if ($params->esEdicion) {
    ...
    $sentencia = $base_de_datos->prepare("UPDATE tienda
                                          SET (codigo, rut, direccion, telefono, l_inicio_atencion, l_fin_atencion, m_inicio_atencion, m_fin_atencion, mm_inicio_atencion, 
                                          mm_fin_atencion, j_inicio_atencion, j_fin_atencion, v_inicio_atencion, v_fin_atencion, s_inicio_atencion, s_fin_atencion, d_inicio_atencion, d_fin_atencion) =
                                          ( '$params->codigo', upper('$params->rut'), upper('$params->direccion'), upper('$params->telefono'), $params->l_inicio_atencion, $params->l_fin_atencion, 
                                          $params->m_inicio_atencion, $params->m_fin_atencion, $params->mm_inicio_atencion, $params->mm_fin_atencion, $params->j_inicio_atencion, $params->j_fin_atencion, 
                                          $params->v_inicio_atencion, $params->v_fin_atencion, $params->s_inicio_atencion, $params->s_fin_atencion, $params->d_inicio_atencion, $params->d_fin_atencion) 
